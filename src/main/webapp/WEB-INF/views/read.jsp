...
<body class="hold-transition fixed skin-red sidebar-mini">
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				<ul class="sidebar-menu">
					...
					<li class="active"><a href=""><i class="fa fa-eye"></i><span>Read</span></a></li>
			...
			<section class="content">
				<div class="box box-solid">
					<div class="box-header">
						<h3 class="box-title">READ FORM</h3>
					</div>
					<div class="box-body">
						...
						<a id="read" href="" class="btn btn-danger">Read</a>
					</div>
				</div>
			</section>
		</div>
	...
	<script type="text/javascript">
		...
		but.href = "${pageContext.request.contextPath}/read/" + sel1.value
				+ "/" + sel2.value;
		sel1.onchange = function() {
			but.href = "${pageContext.request.contextPath}/read/" + this.value
					+ "/" + sel2.value;
		}
